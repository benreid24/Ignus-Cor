...
public:
     ...
     */
    void update(SoundEngine* sEngine);
...
public:
     ...
     */
    RainWeather(Map* m, SoundEngine* sEngine, bool isHard, bool thunder);
...
public:
     ...
     */
    SnowWeather(Map* m, SoundEngine* sEngine, bool isHard, bool thunder);
...
/**
 * This class is to be used directly by Maps and will update and manage the weather in the game
 *
 * \ingroup Maps
 */
class Weather
